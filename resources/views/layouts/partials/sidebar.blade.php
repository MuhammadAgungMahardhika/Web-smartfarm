<x-maz-sidebar :href="route('dashboard')" :logo="asset('images/logo/smartfarm.png')">
    ...
    <x-maz-sidebar-item name="Cage list" :link="route('houseList')" icon="bi bi-house"></x-maz-sidebar-item>
    <?php endif; ?>
    {{-- Menu untuk pemilik --}}
    <?php if(Auth::user()->id_role == '2'): ?>
    <x-maz-sidebar-item name="Dashboard" :link="route('dashboard')" icon="bi bi-house"></x-maz-sidebar-item>
    <x-maz-sidebar-item name="Cage Monitoring" :link="route('houseMonitoring')" icon="bi bi-display"></x-maz-sidebar-item>
    <x-maz-sidebar-item name="Outlier Data" :link="route('outlierData')" icon="bi bi-display"></x-maz-sidebar-item>
    <x-maz-sidebar-item name="Cage Data" :link="route('houseData')" icon="bi bi-files"></x-maz-sidebar-item>
